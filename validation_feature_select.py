...
for test_num in range(10):
    ...
    for emo in emotions:
        if emo == "disgust":
            # AUの選択 4, 6, 7, 9, 10, 20, 25
            exec("model_" + emo + ".fit(np.asarray(X_" + emo + "[:, [2, 4, 5, 6, 7, 12, 14]]), np.asarray(lengths_" + emo + "))")
        elif emo == "anger":
            # AUの選択 1, 2, 5, 6, 7, 10, 12, 14, 20, 25
            exec("model_" + emo + ".fit(np.asarray(X_" + emo + "[:, [0, 1, 3, 4, 5, 7, 8, 9, 12, 14]]), np.asarray(lengths_" + emo + "))")
        elif emo == "sadness":
            # AUの選択 1, 4, 14, 15, 17, 20, 45
            exec("model_" + emo + ".fit(np.asarray(X_" + emo + "[:, [0, 2, 9, 10, 11, 12, 16]]), np.asarray(lengths_" + emo + "))")
        elif emo == "happy":
            # AUの選択 1, 2, 4, 5, 6, 9, 10, 12, 14, 17, 25
            exec("model_" + emo + ".fit(np.asarray(X_" + emo + "[:, [0, 1, 2, 3, 4, 6, 7, 8, 9, 11, 14]]), np.asarray(lengths_" + emo + "))")
        elif emo == "fear":
            # AUの選択 1, 2, 5, 6, 7, 10, 12, 14, 25
            exec("model_" + emo + ".fit(np.asarray(X_" + emo + "[:, [0, 1, 3, 4, 5, 7, 8, 9, 14]]), np.asarray(lengths_" + emo + "))")
        elif emo == "surprise":
            # AUの選択 1, 2, 5, 12, 15, 20 25, 26
            exec("model_" + emo + ".fit(np.asarray(X_" + emo + "[:, [0, 1, 3, 8, 10, 12, 14, 15]]), np.asarray(lengths_" + emo + "))")
    ...
    for emo1 in emotions:
        ...
        exec("""for j in range(count_""" + emo1 + """_test):
            ...
            for emo2 in emotions:
                if emo2 == "disgust":
                    exec("score_" + emo2 + " = model_" + emo2 + ".score(X_""" + emo1 + """_test[j][:, [2, 4, 5, 6, 7, 12, 14]])")
                    exec("print(\\"" + emo2 + ":\\" + str(score_" + emo2 + "))")
                    exec("emotion_eval_list.append([score_" + emo2 + ", \\"\" + emo2 + \"\\"])")
                elif emo2 == "anger":
                    exec("score_" + emo2 + " = model_" + emo2 + ".score(X_""" + emo1 + """_test[j][:, [0, 1, 3, 4, 5, 7, 8, 9, 12, 14]])")
                    exec("print(\\"" + emo2 + ":\\" + str(score_" + emo2 + "))")
                    exec("emotion_eval_list.append([score_" + emo2 + ", \\"\" + emo2 + \"\\"])")
                elif emo2 == "sadness":
                    exec("score_" + emo2 + " = model_" + emo2 + ".score(X_""" + emo1 + """_test[j][:, [0, 2, 9, 10, 11, 12, 16]])")
                    exec("print(\\"" + emo2 + ":\\" + str(score_" + emo2 + "))")
                    exec("emotion_eval_list.append([score_" + emo2 + ", \\"\" + emo2 + \"\\"])")
                elif emo2 == "happy":
                    exec("score_" + emo2 + " = model_" + emo2 + ".score(X_""" + emo1 + """_test[j][:, [0, 1, 2, 3, 4, 6, 7, 8, 9, 11, 14]])")
                    exec("print(\\"" + emo2 + ":\\" + str(score_" + emo2 + "))")
                    exec("emotion_eval_list.append([score_" + emo2 + ", \\"\" + emo2 + \"\\"])")  
                elif emo2 == "fear":
                    exec("score_" + emo2 + " = model_" + emo2 + ".score(X_""" + emo1 + """_test[j][:, [0, 1, 3, 4, 5, 7, 8, 9, 14]])")
                    exec("print(\\"" + emo2 + ":\\" + str(score_" + emo2 + "))")
                    exec("emotion_eval_list.append([score_" + emo2 + ", \\"\" + emo2 + \"\\"])")
                elif emo2 == "surprise":
                    exec("score_" + emo2 + " = model_" + emo2 + ".score(X_""" + emo1 + """_test[j][:, [0, 1, 3, 8, 10, 12, 14, 15]])")
                    exec("print(\\"" + emo2 + ":\\" + str(score_" + emo2 + "))")
                    exec("emotion_eval_list.append([score_" + emo2 + ", \\"\" + emo2 + \"\\"])")                               
